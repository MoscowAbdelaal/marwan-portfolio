...
export default function Experience() {
  return (
    <section id="experience" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-zinc-900/40 animate-fade-in">
            ...
            <div key={job.id} className="relative pl-4 sm:pl-6 border-l border-zinc-800">
              ...
              <ul className="space-y-2">
                {job.points.map((point, i) => (
                  <li
                    key={i}
                    className="text-zinc-400 text-xs sm:text-sm leading-relaxed flex gap-2"
                  >
