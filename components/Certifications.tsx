...
export default function Certifications() {
  return (
    <section id="certifications" className="py-16 sm:py-24 px-4 sm:px-6 animate-fade-in">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-left">
          {certifications.map((cert) => (
            <div
              key={cert.title}
              className="rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 sm:px-5 py-3 sm:py-4 flex flex-col sm:flex-row items-start justify-between gap-2 sm:gap-4"
            >
              <div>
